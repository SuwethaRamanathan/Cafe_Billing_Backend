...
// utils/translate.js
// Uses LibreTranslate - completely FREE, no API key needed for basic usage
...
// export function detectFilledLanguage(nameObj) {
//   if (!nameObj) return "en";
//   // Plain string (old data not yet migrated) — treat as English
...
export function isMissingTranslations(nameObj) {
  if (!nameObj) return true;
  // Plain string = definitely missing ta and hi
